    ...
    <nav className={`Navbar ${navbar ? 'navbarActive' : ''}`}>
      <div className="container">
        <div className="nav-body">
          ...
          <ul className={active}>
            ...
            <li className='dropdown'>
              ...
              <div className='tours-drop'>
                <Link onClick={navToggle} to='/samarkand'>Samarqand</Link>
                <Link onClick={navToggle} className='border' to='/bukhara'>Buxoro</Link>
                <Link onClick={navToggle} to='/khiva'>Xiva</Link>

              </div>
            </li>
            <li><Link onClick={navToggle} to="/about">Biz haqimizda</Link></li>
            <li><Link onClick={navToggle} to="/transport">Transport</Link></li>
            <select className='responsive-select' name="" id="">
          ...
          <select className='desktop-select' name="" id="">
            <option value="">o’zbekcha</option>
            <option value="">русский</option>
            <option value="">english</option>
          </select>
